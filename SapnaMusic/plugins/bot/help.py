...
from SapnaMusic.utils.decorators.language import LanguageStart, languageCB
from SapnaMusic.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers

from SapnaMusic.help.buttons import BUTTONS
from SapnaMusic.help.helper import Helper
...
async def mb_plugin_button(client, CallbackQuery):
    ...
    [
    [
    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data=f"AI_CP")
    ]
    ]
    )
    if cb == "AI":
